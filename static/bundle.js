...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"board"},[_vm._l((_vm.tiles),function(row,rowIndex){return _vm._l((row),function(tile,columnIndex){return _c('piece',{key:((tile.name) + "_" + columnIndex + "_" + rowIndex),style:({ gridColumn: columnIndex + 1, gridRow: rowIndex + 1 }),attrs:{"color":tile.color,"value":tile.value,"ownerColor":tile.owner_color,"resources":tile.resources,"kind":tile.name}})})})],2)}
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"circle bg--green"},[_vm._v("\n\t"+_vm._s(_vm.value)+"\n")])}
__vue__options__.staticRenderFns = []
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-c82e2f16", __vue__options__)
  } else {
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[(_vm.kind === 'tile')?[_c('tile',{attrs:{"color":_vm.color,"value":_vm.value,"ownerColor":_vm.ownerColor,"resources":_vm.resources}})]:(_vm.kind === 'marker')?[_c('markerPiece',{attrs:{"value":_vm.value}})]:void 0],2)}
__vue__options__.staticRenderFns = []
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4a17f64f", __vue__options__)
  } else {
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"rect",class:[_vm.colorClass]},[_vm._v("\n\t"+_vm._s(_vm.value)),(_vm.resources !== undefined)?_c('span',[_vm._v("/"),_c('span',{class:[_vm.ownerColorClass]},[_vm._v(_vm._s(_vm.resources))])]):_vm._e()])}
__vue__options__.staticRenderFns = []
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-10f7815d", __vue__options__)
  } else {
...
function formatBoardPiece(pieceData, column, row) {
  var name = pieceData.name,
      ...
      owner_color = pieceData.owner_color,
...
function formatBoard(boardData) {
  return boardData.filter(function (rowData) {
    return !rowData.every(isSpace);
  }).map(function (rowData, rowIndex) {
    return formatRow(rowData, rowIndex);
  }).join('\n');
}
...
var board = require('./components/board.vue');

var _require = require('./helpers/formatting'),
    formatMoves = _require.formatMoves,
    formatPlayer = _require.formatPlayer;
...
function showBoard() {
  window.fetch('/board').then(function (response) {
...
function executeMove(event) {
  ...
  var kind = inputContainer.querySelector('.js-move-input').value;

  var _inputContainer$query = inputContainer.querySelector('.js-card-input').value.split('_'),
      _inputContainer$query2 = _slicedToArray(_inputContainer$query, 2),
      cardValue = _inputContainer$query2[0],
      cardColor = _inputContainer$query2[1];

  var _inputContainer$query3 = inputContainer.querySelector('.js-tile-input').value.split('_'),
      _inputContainer$query4 = _slicedToArray(_inputContainer$query3, 2),
      tileValue = _inputContainer$query4[0],
      tileColor = _inputContainer$query4[1];

  var parsedTileValue = parseInt(tileValue, 10);
  var parsedCardValue = parseInt(cardValue, 10) || cardValue;
...
function showPlayers() {
  window.fetch('/players').then(function (response) {
    response.json().then(function (players) {
      return players.sort().forEach(showPlayer);
    });
  });
}
